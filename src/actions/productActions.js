...
export const getProducts = (keyword,price, category,rating,currentPage) => async (dispatch) => {
    try {
        ...
        dispatch(productsSuccess({
            products: data.products || [], // Default to empty array if no products found
            productsCount: data.count || 0, // Total products count from API
            resPerPage: data.resPerPage || 0, // Items per page from API
            currentPage 
        }));
    } catch (error) {
